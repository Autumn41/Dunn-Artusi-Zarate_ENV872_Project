...
```{r Figure2, echo = FALSE, fig.cap = "ADD THIS"}
...
```{r Figure3, echo = FALSE, fig.cap = "ADD THIS"}
...
```{r Figure4, echo = FALSE, fig.cap = "ADD THIS"}
...
## Question 2: Are gage heights significantly different between 2001 and 2018?
  ...
  The mean gage heights for each river was higher in 2018 than in 2001, and these differences were statistically significant. Since the t-statistic for the Yadkin, Mills, and French Broad Rivers (-6.22, -5.37, and -6.72) are negative, this indicates that the 2018 gage heights are greater than the 2001 heights. The Yadkin River gage was 0.49 feet higher in 2018 (p-value < 0.05). The Mills River gage was 0.28 feet higher in 2018 (p-value < 0.05). The French Broad River gage was 1.28 feet higher in 2018 (p-value < 0.05). With these results, we reject the null hypothesis and conclude that the average gage heights for 2001 and 2018 are different and that this difference is statistically significant for all three rivers.    
