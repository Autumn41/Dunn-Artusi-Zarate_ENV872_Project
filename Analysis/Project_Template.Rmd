...
subtitle: "Web address for GitHub repository: https://github.com/Autumn41/Dunn-Artusi-Zarate_ENV872_Project.git"
title: "Assessing water level changes from hurricanes from 2000 to 2020"
...
Explain what the readers will see in the graphs - Autumn.
...
Add paragraph explaining/intoduing ts - Autumn. 
...
To answer question 2, we performed a t-test with the objective to identify if the gage heights between 2001 (out baseline year) and 2018 (the year when Hurricane Florence impacted North Carolina) were statistically different. The results from the test can be seen in Table 2. 
...
Add: state the null hypothesis - Autumn. 
