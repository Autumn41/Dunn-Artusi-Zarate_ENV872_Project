...
kable(Results_df, col.names = c("River Name", "2001 Average GH", 
                  ...
                  caption = "Results", digits = c(0, 2, 2, 2, 8)) %>% 
...
Yadkin River, Mills River, and French Broad River had a significant (p-value < 0.05) monotonic upward trend. Catawba River had the largest upward trend (0.206) and Yadkin River and Mills River had the smallest upward trend (0.0218).
