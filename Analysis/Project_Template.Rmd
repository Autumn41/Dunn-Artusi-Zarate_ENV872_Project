...
The Yadkin River gage heigh for September for every year from 2000 - 2020. This shows the gage height variation, and higher values and more spread in the data indicate flooding, likely from hurricanes. Years that had the most spread and highest values were 2004 and 2018.
```{r Plot1, echo = FALSE}
#Plot 1 - Yadkin Gage Height as points on individual plots for September
...
```
The Mills River gage heigh for September for every year from 2000 - 2020. This shows the gage height variation, and higher values and more spread in the data indicate flooding, likely from hurricanes. Years that had the most spread and highest values were 2004 and 2009.
```{r Plot2, echo = FALSE}
#Plot 2 - Mills Gage Height as points on individual plots for September
...
The French Broad River gage heigh for September for every year from 2000 - 2020. This shows the gage height variation, and higher values and more spread in the data indicate flooding, likely from hurricanes. Years that had the most spread and highest values were 2004, 2009, and 2020.
```{r Plot3, echo = FALSE}
#Plot 3 - FrenchBroad Gage Height as points on individual plots for September
